    ...
    if (flight.returnFlight) {
      ...
      inboundHTML = `
        <div class="itinerary-row no-border">
          <div class="airline-info">
            <div class="airline-logo-badge ${ret.operatingLogo || ret.logo || flight.logo}"><img src="https://pics.avs.io/al_size/64/64/${ret.operatingLogo || ret.logo || flight.logo}.png" alt="${ret.operatingLogo || ret.logo || flight.logo}" onerror="this.style.display='none'; this.parentNode.textContent='${ret.operatingLogo || ret.logo || flight.logo}'" style="width: 100%; height: 100%; object-fit: contain; padding: 4px; border-radius: inherit; display: block;"></div>
            <div class="airline-details">
